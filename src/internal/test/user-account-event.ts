...
function fromJSON(jsonString: string): UserAccountEvent {
  ...
  switch (obj.type) {
    case "UserAccountCreated":
      return new UserAccountCreated(obj.id, obj.name, obj.sequenceNumber, obj.version);
    case "UserAccountRenamed":
      return new UserAccountRenamed(obj.id, obj.name, obj.sequenceNumber, obj.version);
    default:
