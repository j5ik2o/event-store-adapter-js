---
allowed-tools: Bash(git:*), Bash(npm:*), Read(*.md), WebFetch(*)
...
- コミットメッセージはConventional Commitsに従い、英語で記述してください。
- co-authorやコミットメッセージに"Claude Code"などのエージェント名は含めないこと。
